namespace RPGCharacterAnims.Lookups
{
    public class HandlerTypes
    {
        ...
        public static readonly string Emote = "Emote";
        public static readonly string EmoteCombat = "EmoteCombat";
        public static readonly string Face = "Face";
        public static readonly string HipShoot = "HipShoot";
        ...
        public static readonly string ClimbLadder = "ClimbLadder";
        ...
        public static readonly string Relax = "Relax";
